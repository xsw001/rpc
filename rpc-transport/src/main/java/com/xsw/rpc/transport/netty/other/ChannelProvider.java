...
public class ChannelProvider {
    ...
    public static Channel get(InetSocketAddress inetSocketAddress, int serializerId) throws InterruptedException {
        String key = inetSocketAddress.toString() + serializerId;
